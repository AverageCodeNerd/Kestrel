...
the panel's own position, and restart and shut down.

Anything the system wants to say arrives as a **notification** in the corner:
a package installing, a folder being created, an update finishing. They fade
after a few seconds or go away when clicked.
